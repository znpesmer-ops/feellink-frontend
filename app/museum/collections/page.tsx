...
import { Landmark, Layers, Users, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-[var(--text)]">Koleksiyon Yönetimi</h1>
          <p className="text-[var(--sub)] mt-1">Müze koleksiyonlarınızı yönetin ve düzenleyin</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-12 text-center">
        <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-[var(--muted)] flex items-center justify-center">
          <Layers className="w-12 h-12 text-[var(--sub)]" />
        </div>
        <h2 className="text-2xl font-semibold text-[var(--text)] mb-3">
          Koleksiyon Yönetimi Yakında
        </h2>
        <p className="text-[var(--sub)] max-w-md mx-auto mb-6">
          Bu sayfada müze koleksiyonlarınızı yönetebilir, eserleri kategorize edebilir ve sergi düzenlemeleri yapabilirsiniz.
        </p>
        <div className="flex flex-wrap justify-center gap-4 mt-8">
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--muted)] text-[var(--sub)]">
            <Layers className="w-4 h-4" />
            <span className="text-sm">Koleksiyon Oluşturma</span>
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--muted)] text-[var(--sub)]">
