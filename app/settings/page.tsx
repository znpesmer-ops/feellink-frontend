  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-6 transition-colors">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          <h2 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-gray-900 dark:text-gray-100">Üyelik & Ücretler</h2>
          <p className="text-gray-600 dark:text-gray-400 text-sm mb-3 md:mb-4">
            Mevcut rolünüz ve ücretli plan seçeneklerini görüntüleyin.
          </p>
          <Link
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
          <h2 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-gray-900 dark:text-gray-100">Gizlilik</h2>
